    ...
    <body>
        <nav class="navbar navbar-inverse">
            <ul class="nav navbar-nav">
                <li><a href="/RevolutionaryReviews/">Homepage<span class="sr-only">(current)</span></a></li>
                ...
                <li class="active"><a href="/Revolutionaryreviews/chisiamo">Chi siamo</a></li>
            </ul>
        ...
        <div style="margin-left: 25px;">
            <h1>Chi siamo?</h1>
            <h4>Il sito della web application che state visualizzando è stato realizzato dai seugenti studendenti dell'istituto <br/>
                tecnico informatico <a href="https://www.itiseveripadova.gov.it/">Francesco Severi</a>:</h4>
            <ul>
                <li>Marco Guidolin : Gestore del progetto</li>
                <li>Francesco Marangoni : Osservatore</li>
                <li>Mauro Salvato : Addetto alle pubbliche relazioni</li>
                <li>Chiara Scolaro : Moderatore</li>
            </ul>
        </div>
    </body>
</html>
